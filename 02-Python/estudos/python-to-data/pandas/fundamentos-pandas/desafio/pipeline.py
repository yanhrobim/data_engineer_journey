from lista_dict_para_dataframe import lista_dict_para_dataframe
from leitura_e_transformacao import leitura_dados_csv, apply_valor_total
from resumo_clientes import valor_total_gasto_p_cliente_in_json
...
def clientes_valor_total_gasto():
    lista_dict_para_dataframe(lista_de_dict=pedidos, caminho_para_csv_salvo='./dados_desafio/')
    leitura_dados = leitura_dados_csv('./dados_desafio/')
    aplicando_valor_total = apply_valor_total(leitura_dados)
    valor_total_gasto_p_cliente_in_json(dataframe_com_valor_total=aplicando_valor_total,
                                        path_para_json='./dados_desafio/')
